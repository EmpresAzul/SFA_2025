...
export const SummaryCards: React.FC<SummaryCardsProps> = ({
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
      ...
      <Card
        className={`bg-gradient-to-br ${saldo >= 0 ? "from-blue-50 to-blue-100 border-blue-200" : "from-orange-50 to-orange-100 border-orange-200"}`}
      >
        <CardContent className="p-4">
          <div className="flex items-center">
            <DollarSign
              className={`h-8 w-8 ${saldo >= 0 ? "text-blue-600" : "text-orange-600"}`}
            />
            <div className="ml-3">
              <p
              ...
              <p
                className={`text-xl font-bold ${saldo >= 0 ? "text-blue-900" : "text-orange-900"}`}
              >
                R$ {saldo.toFixed(2)}
              </p>
              <p
                className={`text-xs ${saldo >= 0 ? "text-blue-600" : "text-orange-600"} mt-1`}
              >
