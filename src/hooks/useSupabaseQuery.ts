...
export const useSupabaseQuery = () => {
  ...
  return {
    ...
    useSaldosBancarios: () => ({ data: saldosBancarios.saldos, isLoading: saldosBancarios.loading }),
    ...
    useCreateSaldoBancario: () => ({ mutateAsync: saldosBancarios.createSaldo, isPending: saldosBancarios.loading }),
    useUpdateSaldoBancario: () => ({ mutateAsync: saldosBancarios.updateSaldo, isPending: saldosBancarios.loading }),
    useDeleteSaldoBancario: () => ({ mutateAsync: saldosBancarios.deleteSaldo, isPending: saldosBancarios.loading }),
